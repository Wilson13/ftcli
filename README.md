...
ftctl/1.0.5 darwin-x64 node-v12.12.0
$ ftctl --help [COMMAND]
USAGE
  $ ftctl COMMAND
...
...
_See code: [src/commands/release-stage.ts](https://github.com/Wilson13/ftctl/blob/v1.0.5/src/commands/release-stage.ts)_
<!-- commandsstop -->
